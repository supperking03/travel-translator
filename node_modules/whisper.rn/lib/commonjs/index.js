...
const installJSIBindingsIfNeeded = async () => {
  ...
  jsiInstalled = true;
  return _NativeRNWhisper.default.installJSIBindings().then(() => {
...
class WhisperContext {
  ...
  transcribeWithNativeMethod(method, data) {
    ...
    return {
      ...
      promise: _NativeRNWhisper.default[method](this.id, jobId, data, {
        ...rest,
  ...
  async bench(maxThreads) {
    const result = await _NativeRNWhisper.default.bench(this.id, maxThreads);
