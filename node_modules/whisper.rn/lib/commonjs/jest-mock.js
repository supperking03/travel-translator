...
if (!_reactNative.NativeModules.RNWhisper) {
  _reactNative.NativeModules.RNWhisper = {
    ...
    startRealtimeTranscribe: jest.fn((contextId, jobId) => {
      setTimeout(() => {
        // Start
        _reactNative.DeviceEventEmitter.emit('@RNWhisper_onRealtimeTranscribe', {
          contextId,
          jobId,
          payload: {
            isCapturing: true,
        ...
        // End event
        _reactNative.DeviceEventEmitter.emit('@RNWhisper_onRealtimeTranscribeEnd', {
          contextId,
          jobId,
          payload: {}
        });
