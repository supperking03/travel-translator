...
export interface Spec extends TurboModule {
    ...
    installJSIBindings(): Promise<{
        success: boolean;
    }>;
    initContext(options: NativeContextOptions): Promise<NativeWhisperContext>;
    releaseContext(contextId: number): Promise<void>;
    releaseAllContexts(): Promise<void>;
    transcribeFile(contextId: number, jobId: number, pathOrBase64: string, options: {}): Promise<TranscribeResult>;
    transcribeData(contextId: number, jobId: number, dataBase64: string, options: {}): Promise<TranscribeResult>;
    ...
    vadDetectSpeech(contextId: number, audioData: string, // base64 encoded float32 PCM data
    options: VadOptions): Promise<VadSegment[]>;
    vadDetectSpeechFile(contextId: number, filePathOrBase64: string, options: VadOptions): Promise<VadSegment[]>;
