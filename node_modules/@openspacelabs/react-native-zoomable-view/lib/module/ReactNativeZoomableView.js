...
class ReactNativeZoomableView extends Component {
  ...
  render() {
    ...
    }, children), visualTouchFeedbackEnabled && (touches === null || touches === void 0 ? void 0 : touches.map(touch => doubleTapDelay && /*#__PURE__*/React.createElement(AnimatedTouchFeedback, {
      x: touch.x,
      y: touch.y,
      key: touch.id,
